...
- 한국장 리포트는 평일 16:30 KST에 실행하고, 16:45와 17:00에 백업 실행을 시도합니다.
- 미국장 리포트는 화~토 06:30 KST에 실행하고, 06:45와 07:00에 백업 실행을 시도합니다.
- 같은 보고 날짜와 시장의 본문 발송 기록을 확인하면 백업 실행은 건너뜁니다. 기록은 GitHub Actions 캐시에 보관합니다.
- 예약이 자정을 넘어 지연돼도 원래 예약의 시장과 보고 날짜를 유지합니다. 수동 실행은 정기 발송 기록을 변경하지 않습니다.
- GitHub 예약은 실행 시각을 보장하지 않습니다. 백업도 같은 서비스에서 실행되므로 전체 예약이 지연되면 함께 늦을 수 있습니다.
